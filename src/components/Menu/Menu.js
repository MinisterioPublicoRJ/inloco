...
const Menu = ({menuItems, menuTitle, parentMenuTitle, layers, onLayerClick, onMenuItemClick, onMouseOver, sidebarLeftWidth, onMouseOut, onUntoggleAllClick, selected, currentLevel}) => {
